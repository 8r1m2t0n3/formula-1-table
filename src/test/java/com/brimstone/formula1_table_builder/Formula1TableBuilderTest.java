...
class Formula1TableBuilderTest extends Formula1TableBuilder {
  ...
  void parseFileLine_shouldReturnArrayWhichContainsStringsWhichWereSeparatedByUnderscores() {
    assertEquals(Arrays.asList("PGS2018-05-24", "12:08:36.586"),
        parseFileLine("PGS2018-05-24_12:08:36.586"));
    assertEquals(Arrays.asList("EOF", "Esteban Ocon", "FORCE INDIA MERCEDES"),
  ...
  void buildTableOutOfMaps_ShouldReturnCorrectTable() {
    ...
    abbriviationsMap.put("FAM",
        new ArrayList<>(Arrays.asList("Fernando Alonso", "MCLAREN RENAULT")));
    abbriviationsMap.put("LSW",
        new ArrayList<>(Arrays.asList("Lance Stroll", "WILLIAMS MERCEDES")));
  ...
  void parseFileAndFillMap_shouldReturnFilledWithCorrectDataMap() {
    ...
    abbreviationsTestMap.put("DRR",
        new ArrayList<>(Arrays.asList("Daniel Ricciardo", "RED BULL RACING TAG HEUER")));
    abbreviationsTestMap.put("SVF", new ArrayList<>(Arrays.asList("Sebastian Vettel", "FERRARI")));
    abbreviationsTestMap.put("SPF",
        new ArrayList<>(Arrays.asList("Sergio Perez", "FORCE INDIA MERCEDES")));
    ...
    assertEquals(abbreviationsTestMap,
